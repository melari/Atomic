...
namespace Atomic_Server
{
    static class Program
    {
        static void Main(string[] args)
        {
            NetPeerConfiguration config = new NetPeerConfiguration("Atomic"); //This should match the identifier on the client side.
            ...
            Console.WriteLine("======= ATOMIC GAME SERVER RUNNING =========");
            Console.WriteLine("Press ESC to shut down.");
            Console.WriteLine("");
                ...
                while ((msg = server.ReadMessage()) != null)
                {
                    switch (msg.MessageType)
                    {
                        ...
                        case NetIncomingMessageType.Data:
                            ...
                            //
                            int xinput = msg.ReadSByte();
                            int yinput = msg.ReadSByte();
