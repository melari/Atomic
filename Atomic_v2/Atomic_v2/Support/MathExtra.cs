...
namespace Atomic
{
    ...
    public static class MathExtra
    {
        ...
        /// <summary>
        /// Gets the corresponding X component in retangular corridants from a given point in polar coordinates.
        /// </summary>
        /// <param name="r">Radius component of point</param>
        /// <param name="theta">Theta component of point.</param>
        /// <returns>corresponding x component</returns>
        public static float ComponentX(float r, float theta)
        {
            return (float)Math.Cos((double)theta) * r;
        }

        /// <summary>
        /// Gets the corresponding Y component in retangular corridants from a given point in polar coordinates.
        /// </summary>
        /// <param name="r">Radius component of point</param>
        /// <param name="theta">Theta component of point.</param>
        /// <returns>corresponding y component</returns>
        public static float ComponentY(float r, float theta)
        {
